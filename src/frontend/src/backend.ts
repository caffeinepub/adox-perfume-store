...
export interface backendInterface {
    ...
    initializeProducts(caller: Principal): Promise<void>;
    isCallerAdmin(): Promise<boolean>;
    reorderProducts(ids: Array<bigint>): Promise<void>;
    setSiteContent(pagename: string, content: string): Promise<void>;
}
import type { ExternalBlob as _ExternalBlob, Product as _Product, ProductInput as _ProductInput, ProductUpdate as _ProductUpdate, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createProduct(arg0: ProductInput): Promise<Product> {
        if (this.processError) {
            try {
                const result = await this.actor.createProduct(await to_candid_ProductInput_n10(this._uploadFile, this._downloadFile, arg0));
    ...
    async editProduct(arg0: ProductUpdate): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.editProduct(await to_candid_ProductUpdate_n17(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async initializeProducts(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.initializeProducts(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async reorderProducts(arg0: Array<bigint>): Promise<void> {
        if (this.processError) {
            try {
...
async function to_candid_ProductInput_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ProductInput): Promise<_ProductInput> {
    return await to_candid_record_n11(_uploadFile, _downloadFile, value);
}
async function to_candid_ProductUpdate_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ProductUpdate): Promise<_ProductUpdate> {
